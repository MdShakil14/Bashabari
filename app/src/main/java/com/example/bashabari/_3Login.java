...
public class _3Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__3_login);
            ...
            ownerReference.child(getPhone_no).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    try {
                        ...
                        //FancyToast.makeText(_3Login.this,"Invalid Phone Number or Password1",Toast.LENGTH_LONG,FancyToast.ERROR,true).show();
e.printStackTrace();
